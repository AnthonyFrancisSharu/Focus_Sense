...
import { LogIn, Mail, Lock, Loader2, Eye, EyeOff, Sun, Moon } from 'lucide-react'
...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900/80 via-gray-800/60 to-primary-900/70" />
